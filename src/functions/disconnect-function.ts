...
export class DisconnectFunction extends FunctionAbstract<any,any> {
  static instance: DisconnectFunction;
  ...
  protected async execute(request: WebsocketAPIGatewayEvent): Promise<CustomResponse<any>> {
    ...
    return Response.ok(await this.websocketService.onDisconnect(request)).build();
  }
